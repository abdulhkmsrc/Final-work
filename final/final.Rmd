...
abstract: |
The power of nuclear energy sources and mass destruction weapons were discovered in early 1930's. From that time, nuclear energy has been used for multiple purposes. Although, it has some benefits to both humanity and environment, it has multiple threts against living creatures.
To determine which country is responsible for nuclear explosions that occurred all around the world.
Data set from github were used with data-based table, garph and map. Then hypothesis testing was used to obtain convincing implications.
---
...
ggplot(nuclear_explosions, aes(x = Date.Year)) +
